...
(deftest currentMaxRegisterValueTest
  (testing "example from instructions"
           (is (= (core/currentMaxRegisterValue ["b inc 5 if a > 1"
                                              "a inc 1 if b < 5"
                                              "c dec -10 if a >= 1"
                                              "c inc -20 if c == 10"]) 1))
           )
...
(deftest allTimeMaxRegisterValueTest
         (testing "example from instructions"
                  (is (= (core/allTimeMaxRegisterValue ["b inc 5 if a > 1"
                                                     "a inc 1 if b < 5"
                                                     "c dec -10 if a >= 1"
                                                     "c inc -20 if c == 10"]) 10))
                  )
